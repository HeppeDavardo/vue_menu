...
export default {
  ...
  created() {
    let token;
        ...
        .then(() => {
            fetch('https://helenamarias.com/wp-json/wp/v2/posts?status=private&categories=10',{
                method: 'GET',
                headers: {
            ...
            .then(data => { 
                ...
                ret.innerHTML = `<h2 id="menupunkt">Vin</h2>
                <p class="menupunktDesc">Nogle af vores vine er økologiske. Hvis du har nogle spørgsmål, så henven dig venligst til personalet.</p>
                `;
